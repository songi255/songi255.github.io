...
또한 JVM의 GC가 예측하기 힘들게 동작하는 점도 고려해야 합니다. 하지만 **요즘의 GC는 성능이 매우 좋은 편이라 대부분의 상황에서 문제가 되지 않습니다.**
...
그 외 Java를 잘못사용할 수도 있습니다. 무분별한 암시적 박싱/언박싱부터, 잘못된 자료구조 선택, 람다식의 생성비용을 놓치는 등 다양한 실수를 할 수 있습니다.

문제는 이런 사소한 실수가 잘못된 신념으로 이어질 수 있다는 것입니다.
...
최적화에 대해 Donald Knuth가 제시하는 지침이 있습니다.
...
위에서 알아본 것 처럼, 실용적인 측면에서는 작은 단위의 벤치마크 결과에서 많은 것을 기대하지 않는 것이 좋습니다. 하지만 모든 벤치마크가 의미없다는 것은 아닙니다.
...
- [Java 코드의 실행과정](https://www.geeksforgeeks.org/compilation-execution-java-program/)
- [JIT Compiler가 최적화 하는 것들](https://www.ibm.com/docs/en/sdk-java-technology/8?topic=compiler-how-jit-optimizes-code)
- [마이크로 벤치마킹에 대한 stackoverflow 답변](https://stackoverflow.com/questions/504103/how-do-i-write-a-correct-micro-benchmark-in-java)
- [잘못된 마이크로 벤치마킹과 고려사항](https://web.archive.org/web/20200606234821/https://www.ibm.com/developerworks/java/library/j-jtp02225/)
- [JVM의 벤치마킹 함정과 JMH](https://www.oracle.com/technical-resources/articles/java/architect-benchmarking.html)
